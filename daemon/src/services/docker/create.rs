...
use protocol::{docker::ServerSpec, LABEL_MANAGED, LABEL_NAME, LABEL_OWNER, LABEL_SERVER_ID};
use std::collections::HashMap;
use tracing::info;

impl DockerManager {
    /// Create a new server container with specified spec and labels
    pub async fn create_server_container(&self, spec: &ServerSpec) -> Result<String> {
