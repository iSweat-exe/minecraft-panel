# Audit de Qualité & Maintenabilité — minecraft-panel daemon
...
|---|---|---|---|---|
| REFACTO-001 | [main.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/main.rs#L57-L120) | Erreur / Dette | **Élevé** | Double appel à `db::init_db()` |
...
| REFACTO-004 | [main.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/main.rs#L68-L104) | Séparation resp. | **Élevé** | Logique de backfill inline dans main |
...
| REFACTO-007 | [update.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/update.rs) | Duplication | **Élevé** | Logique de swap binaire dupliquée 2x |
| REFACTO-008 | [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L139-L227) | Séparation resp. | **Élevé** | UserAuth fait requête DB dans un extractor |
| REFACTO-009 | [docker.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/docker.rs) | Séparation resp. | **Élevé** | Fichier de 433 lignes, ~13 handlers en un seul fichier |
| REFACTO-010 | [scheduler.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/scheduler.rs#L28-L30) | Anti-pattern | **Élevé** | Jobs d'automation ne font que loguer, pas d'exécution réelle |
| REFACTO-011 | [info.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/info.rs#L128-L176) | Complexité | **Élevé** | `reconstruct_spec` imbrication 6 niveaux |
| REFACTO-012 | [create.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/create.rs#L52) | Gestion erreurs | **Élevé** | `if let Ok(...)` avale silencieusement l'erreur de sérialisation |
| REFACTO-013 | [delete.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/delete.rs#L27-L35) | Gestion erreurs | **Élevé** | `let _ =` sur suppression DB après delete Docker |
| REFACTO-014 | [auth_routes.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/auth_routes.rs#L32) | Gestion erreurs | **Moyen** | `hash_password` unwrap sur bcrypt::hash |
| REFACTO-015 | [metrics.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/metrics.rs#L19-L21) | Gestion erreurs | **Moyen** | 3x `.lock().unwrap()` sur Mutex |
| REFACTO-016 | [mod.rs (routes)](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/mod.rs#L44) | Gestion erreurs | **Moyen** | `state.lock().unwrap()` dans rate limiter |
| REFACTO-017 | [pty.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/pty.rs#L77-L78) | Gestion erreurs | **Moyen** | `.unwrap()` sur PTY reader/writer |
| REFACTO-018 | [ping.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/ping.rs#L26-L50) | Complexité | **Moyen** | Nesting 6+ niveaux pour extraire le port |
| REFACTO-019 | [patch.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/patch.rs) + [create.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/create.rs) | Duplication | **Moyen** | Logique de validation/allocation de ports dupliquée |
| REFACTO-020 | [automations.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/automations.rs) + [history.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/history.rs) + [sessions.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/sessions.rs) | Duplication | **Moyen** | Pattern CRUD identique — DbRow → Response mapping |
| REFACTO-021 | [backups.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/backups.rs#L58) | Incohérence | **Moyen** | Chemins hardcodés `/var/lib/docker/volumes/` |
| REFACTO-022 | [users.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/users.rs#L19) | Anti-pattern | **Moyen** | `password_hash` exposé dans la réponse API |
| REFACTO-023 | [host.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/host.rs) + [health.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/health.rs) + [memory.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/memory.rs) | Performance | **Moyen** | Création d'un `System::new()` à chaque requête |
| REFACTO-024 | [db.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/db.rs#L93-L106) | Incohérence | **Moyen** | Migrations manuelles avec `.ok()` |
| REFACTO-025 | [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L159) | Anti-pattern | **Moyen** | Détection JWT par `starts_with("ey")` |
| REFACTO-026 | [auth_routes.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/auth_routes.rs#L92) | Incohérence | **Moyen** | Messages d'erreur en français mélangés à l'anglais |
| REFACTO-027 | [files/action.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/files/action.rs#L44-L82) | Anti-pattern | **Moyen** | `std::process::Command` bloquant en contexte async |
| REFACTO-028 | [metrics.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/metrics.rs#L6-L14) | Performance | **Moyen** | `lazy_static!` + `Mutex` au lieu de `OnceLock` / `std::sync::LazyLock` |
| REFACTO-029 | [hash.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/files/hash.rs) | Performance | **Faible** | Lecture du fichier entier en mémoire pour le hashing |
| REFACTO-030 | [update.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/update.rs#L155-L157) | Dette technique | **Moyen** | TODO : asset CI/CD, code commenté |
| REFACTO-031 | [automations.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/automations.rs#L114) | Dette technique | **Moyen** | TODO : suppression dynamique du scheduler |
| REFACTO-032 | [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L105-L106) | Code mort | **Moyen** | `ProtocolVersionCheck` marqué `#[allow(dead_code)]` |
| REFACTO-033 | [info.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/info.rs#L58) | Code mort | **Faible** | `get_server_status` marqué `#[allow(dead_code)]` |
| REFACTO-034 | [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L220-L227) | Séparation resp. | **Moyen** | Fallback silencieux vers "system" user |
| REFACTO-035 | [download.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/files/download.rs) | Anti-pattern | **Faible** | `.unwrap()` dans fallback de Response builder |
| REFACTO-036 | Multiples fichiers | Incohérence | **Faible** | Mix de `\r\n` et `\n` comme line endings |
| REFACTO-037 | [main.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/main.rs#L122-L124) | Dette technique | **Élevé** | Erreur du scheduler silencieusement avalée avec `eprintln!` |
...
- **Fichiers** : [console.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/console.rs#L25), [console.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/console.rs#L56), [create.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/create.rs#L56), [delete.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/delete.rs#L9), [info.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/info.rs#L60), [info.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/info.rs#L100), [power.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/power.rs#L12), [tty.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/tty.rs#L8), [command.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/command.rs#L50), [crashes.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/crashes.rs#L15), [logs.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/logs.rs#L21), [ping.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/ping.rs#L13)
- **Type** : Duplication
...
- **Fichier** : [update.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/update.rs)
...
- **Fichiers** : [create.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/create.rs#L20-L49) et [patch.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/patch.rs#L48-L77)
- **Type** : Duplication
...
- **Fichiers** : [automations.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/automations.rs), [history.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/history.rs), [sessions.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/sessions.rs)
- **Type** : Duplication
...
- **Fichier** : [docker/info.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/info.rs#L128-L176)
- **Type** : Complexité
...
- **Fichier** : [ping.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/ping.rs#L26-L50)
- **Type** : Complexité
...
- **Fichier** : [main.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/main.rs#L68-L104)
...
- **Fichier** : [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L139-L227)
- **Type** : Séparation des responsabilités
...
- **Fichier** : [docker.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/docker.rs)
- **Type** : Séparation des responsabilités
...
- **Fichier** : [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L220-L227)
- **Type** : Séparation des responsabilités
...
- **Fichier** : [scheduler.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/scheduler.rs#L28-L30)
- **Type** : Anti-pattern
...
- **Fichier** : [users.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/users.rs#L19)
- **Type** : Anti-pattern
...
- **Fichier** : [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L159)
- **Type** : Anti-pattern
...
- **Fichier** : [files/action.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/files/action.rs#L44-L78)
- **Type** : Anti-pattern
...
- **Fichier** : [download.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/files/download.rs#L23-L52)
- **Type** : Anti-pattern
...
- **Fichier** : [auth.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/auth.rs#L105-L129)
- **Type** : Code mort
...
- **Fichier** : [docker/info.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/docker/info.rs#L58-L96)
- **Type** : Code mort
...
- **Fichier** : [main.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/main.rs#L57-L66) et [main.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/main.rs#L111-L120)
...
- **Fichier** : [create.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/create.rs#L52-L59)
...
- **Fichier** : [delete.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/delete.rs#L27-L35)
- **Type** : Gestion d'erreurs
...
- **Fichier** : [auth_routes.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/auth_routes.rs#L32)
- **Type** : Gestion d'erreurs
...
- **Fichier** : [metrics.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/metrics.rs#L19-L21)
- **Type** : Gestion d'erreurs
...
- **Fichier** : [routes/mod.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/mod.rs#L44)
- **Type** : Gestion d'erreurs
...
- **Fichier** : [pty.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/pty.rs#L77-L78)
- **Type** : Gestion d'erreurs
...
- **Fichier** : [backups.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/backups.rs#L24-L58)
- **Type** : Incohérence architecturale
...
- **Fichier** : [db.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/db.rs#L93-L106)
- **Type** : Incohérence architecturale
...
- **Fichiers** : [auth_routes.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/auth_routes.rs#L92), [users.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/users.rs#L101-L170), [patch.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/patch.rs#L26), [create.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/servers/create.rs#L35-L36), [docker.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/docker.rs#L59)
- **Type** : Incohérence architecturale
...
- **Fichiers** : [host.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/host.rs#L8), [health.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/health.rs#L14), [memory.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/system/memory.rs#L7)
- **Type** : Performance
...
- **Fichier** : [metrics.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/metrics.rs#L6-L14)
- **Type** : Performance
...
- **Fichier** : [files/hash.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/files/hash.rs#L9-L10)
- **Type** : Performance
...
- **Fichier** : [update.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/update.rs#L155-L157)
...
- **Fichier** : [automations.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/routes/v1/automations.rs#L114)
- **Type** : Dette technique
...
- **Fichier** : [main.rs](file:///c:/Users/iswea/Desktop/minecraft-panel/daemon/src/main.rs#L122-L124)
- **Type** : Dette technique
