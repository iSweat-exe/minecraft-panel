...
#[tauri::command]
pub async fn node_docker_list_containers(
    node_url: String,
    node_token: String,
) -> Result<Vec<DockerContainerInfo>, AppError> {
...
pub async fn node_docker_container_action(
    ...
    DaemonClient::new(node_url, node_token)
        .docker_container_action(&container_id, &action)
        .await
}

#[tauri::command]
pub async fn node_docker_system_prune(
    node_url: String,
    node_token: String,
) -> Result<String, AppError> {
    DaemonClient::new(node_url, node_token)
...
#[tauri::command]
pub async fn node_docker_list_images(
    node_url: String,
    node_token: String,
) -> Result<Vec<DockerImageInfo>, AppError> {
    DaemonClient::new(node_url, node_token)
        .docker_list_images()
        .await
}
...
#[tauri::command]
pub async fn node_docker_pull_image(
    node_url: String,
    node_token: String,
    image_name: String,
) -> Result<String, AppError> {
...
#[tauri::command]
pub async fn node_docker_remove_image(
    node_url: String,
    node_token: String,
    image_id: String,
) -> Result<String, AppError> {
    DaemonClient::new(node_url, node_token)
        .docker_remove_image(&image_id)
        .await
}
...
#[tauri::command]
pub async fn node_docker_inspect_container(
    node_url: String,
    node_token: String,
    container_id: String,
) -> Result<String, AppError> {
    DaemonClient::new(node_url, node_token)
        .docker_container_inspect(&container_id)
        .await
}
...
pub async fn node_docker_update_container(
    ...
    DaemonClient::new(node_url, node_token)
        .docker_update_container(&container_id, req)
        .await
}
